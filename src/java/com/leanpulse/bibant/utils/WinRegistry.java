 ...
 * All rights reserved.
 *********************************************/
package com.leanpulse.bibant.utils;
...
/**
 * Utility class to read and write keys from the Windows registry. 
 * 
...
public class WinRegistry {
	...
	private static Preferences systemRoot = null; // Lazily instantiate to avoid warnings due to rights restrictions
	...
	public static String readString(int hkey, String key, String valueName)
		...
		if (hkey == HKEY_LOCAL_MACHINE) {
			return readString(getSystemRoot(), hkey, key, valueName);
	...
	public static Map<String, String> readStringValues(int hkey, String key)
			...
			InvocationTargetException {
		if (hkey == HKEY_LOCAL_MACHINE) {
			return readStringValues(getSystemRoot(), hkey, key);
		} else if (hkey == HKEY_CURRENT_USER) {
	...
	public static List<String> readStringSubKeys(int hkey, String key)
			...
			InvocationTargetException {
		if (hkey == HKEY_LOCAL_MACHINE) {
			return readStringSubKeys(getSystemRoot(), hkey, key);
		} else if (hkey == HKEY_CURRENT_USER) {
	...
	public static void createKey(int hkey, String key)
		...
		int[] ret;
		if (hkey == HKEY_LOCAL_MACHINE) {
			ret = createKey(getSystemRoot(), hkey, key);
			regCloseKey
					.invoke(getSystemRoot(), new Object[] { new Integer(ret[0]) });
		} else if (hkey == HKEY_CURRENT_USER) {
	...
	public static void writeStringValue(int hkey, String key, String valueName,
		...
		if (hkey == HKEY_LOCAL_MACHINE) {
			writeStringValue(getSystemRoot(), hkey, key, valueName, value);
		} else if (hkey == HKEY_CURRENT_USER) {
	...
	public static void deleteKey(int hkey, String key)
		...
		int rc = -1;
		if (hkey == HKEY_LOCAL_MACHINE) {
			rc = deleteKey(getSystemRoot(), hkey, key);
		} else if (hkey == HKEY_CURRENT_USER) {
	...
	public static void deleteValue(int hkey, String key, String value)
		...
		int rc = -1;
		if (hkey == HKEY_LOCAL_MACHINE) {
			rc = deleteValue(getSystemRoot(), hkey, key, value);
		} else if (hkey == HKEY_CURRENT_USER) {
	...
	private static Preferences getSystemRoot() {
		if(systemRoot == null)
